...
set_property -dict { PACKAGE_PIN M19    IOSTANDARD LVCMOS33 } [get_ports { sw_au }]; #IO_L7P_T1_AD2P_35 Sch=SW1
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { sw_p[0]  }]; #IO_L5P_T0_34            Sch=CK_IO0
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { sw_p[1]  }]; #IO_L2N_T0_34            Sch=CK_IO1
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { sw_p[2]  }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=CK_IO2
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { sw_p[3]  }]; #IO_L3N_T0_DQS_34        Sch=CK_IO3
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { update_money  }]; #IO_L10P_T1_34           Sch=CK_IO4
...
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { led[0]  }]; #IO_L9N_T1_DQS_34        Sch=CK_IO7
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L21P_T3_DQS_34       Sch=CK_IO8
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L21N_T3_DQS_34       Sch=CK_IO9
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { led[2] }]; #IO_L9P_T1_DQS_34        Sch=CK_IO10
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { led[3] }]; #IO_L19N_T3_VREF_34      Sch=CK_IO11
...
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { seg_0_data[0] }]; #IO_L19N_T3_VREF_13  Sch=CK_IO26
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { seg_0_data[1] }]; #IO_L6N_T0_VREF_13   Sch=CK_IO27
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { seg_0_data[2] }]; #IO_L22P_T3_13       Sch=CK_IO28
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { seg_0_data[3] }]; #IO_L11P_T1_SRCC_13  Sch=CK_IO29
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { seg_1_data[0] }]; #IO_L11N_T1_SRCC_13  Sch=CK_IO30
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { seg_1_data[1] }]; #IO_L17N_T2_13       Sch=CK_IO31
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { seg_1_data[2] }]; #IO_L15P_T2_DQS_13   Sch=CK_IO32
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { seg_1_data[3] }]; #IO_L21N_T3_DQS_13   Sch=CK_IO33
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { seg_2_data[0] }]; #IO_L16P_T2_13       Sch=CK_IO34
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { seg_2_data[1] }]; #IO_L22N_T3_13       Sch=CK_IO35
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { seg_2_data[2] }]; #IO_L13N_T2_MRCC_13  Sch=CK_IO36
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { seg_2_data[3] }]; #IO_L13P_T2_MRCC_13  Sch=cCK_IO37
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { seg_3_data[0] }]; #IO_L15N_T2_DQS_13   Sch=CK_IO38
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { seg_3_data[1] }]; #IO_L14N_T2_SRCC_13  Sch=CK_IO39
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { seg_3_data[2] }]; #IO_L16N_T2_13       Sch=CK_IO40
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { seg_3_data[3] }]; #IO_L14P_T2_SRCC_13  Sch=CK_IO41
...
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { rs }]; #IO_L18N_T2_13      Sch=CK_A0
set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS33 } [get_ports { rw }]; #IO_L20P_T3_13      Sch=CK_A1
set_property -dict { PACKAGE_PIN W11   IOSTANDARD LVCMOS33 } [get_ports { en }]; #IO_L18P_T2_13      Sch=CK_A2
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { data[0] }]; #IO_L21P_T3_DQS_13  Sch=CK_A3
set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { data[1] }]; #IO_L19P_T3_13      Sch=CK_A4
set_property -dict { PACKAGE_PIN U10   IOSTANDARD LVCMOS33 } [get_ports { data[2] }]; #IO_L12N_T1_MRCC_13 Sch=CK_A5
...
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { data[3] }]; #IO_L15P_T2_DQS_AD12P_35 Sch=AD12_P   ChipKit pin=A6
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { data[4] }]; #IO_L15N_T2_DQS_AD12N_35 Sch=AD12_N   ChipKit pin=A7
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { data[5]  }]; #IO_L1P_T0_AD0P_35       Sch=AD0_P    ChipKit pin=A8
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { data[6]  }]; #IO_L1N_T0_AD0N_35       Sch=AD0_N    ChipKit pin=A9
set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { data[7]  }]; #IO_L2P_T0_AD8P_35       Sch=AD8_P    ChipKit pin=A10
